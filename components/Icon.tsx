...
export const MagicIcon: React.FC<SVGProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.388 1.62a15.998 15.998 0 00-1.622 3.385m-5.043-.025a15.998 15.998 0 01-3.388-1.621m7.704 4.34a2.25 2.25 0 00-2.4-2.245m-5.78 1.128a2.25 2.25 0 01-2.4-2.245m0 0a4.5 4.5 0 008.4 2.245m-8.4-2.245c0-3.995 3.58-7.168 8.19-9.126a12.008 12.008 0 018.19 9.126m-8.19 3.108a3 3 0 100-6.216m0 6.216a3 3 0 000-6.216" /></svg>
);
export const EraseIcon: React.FC<SVGProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m0 0l-6.75-6.75M12 19.5l6.75-6.75" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-15" /><path strokeLinecap="round" strokeLinejoin="round" d="M8.625 4.5c.394.028.784.053 1.175.053h4.4c.39 0 .78-.025 1.175-.053M4.5 8.625c.028.394.053.784.053 1.175v4.4c0 .39-.025.78-.053 1.175M19.5 8.625c-.028.394-.053.784-.053 1.175v4.4c0 .39.025.78.053 1.175" /></svg>
);
...
export const LightbulbIcon: React.FC<SVGProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a6.01 6.01 0 00-1.5-1.84m1.5 1.84a6.01 6.01 0 01-1.5-1.84m-1.5-3.363a11.964 11.964 0 013-3.036m-3 3.036a11.964 11.964 0 00-3 3.036m0-3.036a11.964 11.964 0 013-3.036m0 0c1.033.626 2.167 1.048 3.375 1.25m-3.375-1.25c-1.208.202-2.342.624-3.375 1.25" /></svg>
);
export const BroomIcon: React.FC<SVGProps> = (props) => (
...
export const RectangleIcon: React.FC<SVGProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 9.563C9 9.254 9.254 9 9.563 9h4.874c.31 0 .563.254.563.563v4.874c0 .31-.253.563-.563.563H9.563C9.254 15 9 14.746 9 14.437V9.563z" /></svg>
);
export const CircleIcon: React.FC<SVGProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);
...
export const ImportIcon: React.FC<SVGProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v12m0 0l-3.75-3.75M12 16.5l3.75-3.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);
...
export const SlashIcon: React.FC<SVGProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15" /></svg>
);